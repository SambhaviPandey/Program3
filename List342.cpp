 ...
 * the interface that was defined in List342.h.The code is
 * commented out because it is already implemented in List342.h
 * according to the directions in the assignment.
 */
...
bool List342<ItemType>::Remove(ItemType target, ItemType &result)
{
    ...
    //Checks previousNode
    while (previousNode->next != NULL && *previousNode->next->data < target)
    {
